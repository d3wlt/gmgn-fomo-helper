...
These fixture gates do not replace a signed-in smoke test against changed third-party APIs. Unpacked extension reload and GMGN/DeBot page refresh are still required after installation.
