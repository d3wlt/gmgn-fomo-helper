...
A private Chrome MV3 extension that brings FOMO context into GMGN. Version **0.53.40** continues the private fork of “better gmgn,” originally based on upstream v0.46.27.
...
npm run verify
python3 scripts/build-release.py --tag v0.53.40
```
